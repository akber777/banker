...
const Slider = (props) => {
    ...
    const {meqale, photo} = props


    return (
        <div className="slider">
            {
                meqale !== undefined && meqale !== false && (
                    <div className="mobSlider">
                        ...
                        <div className="mobSlider__slide">
                            ...
                            >
                                {
                                    meqale.map((item, index) => (
                                        <div className="mobSlider__slide--items" key={index}>
                                            <NavLink to={item.slug}>
                                                <div className="mobSlider__imgBox">
                                                    <img
                                                        src={item.img !== undefined && item.img.length !== 0 && item.img !== null ? item.img.cover : ''}
                                                        alt=""
                                                    />
                                                </div>
...
Slider.propTypes = {
    meqale: PropTypes.array.isRequired,
};

...
const Vacancies = () => {
    ...
    useLayoutEffect(() => {
        ...
        $('.myInput').keyup(function () {
            ...
            $(this).parents('.vacancies__itemBox').find('.listed  li').each(function () {
            ...
            $(this).parents('.vacancies__itemBox').find('.cities  li').each(function () {
                var lcval = $(this).text().toLowerCase();
                if (lcval.indexOf(value) > -1) {
                    $(this).show()
            ...
            $(this).parents('.vacancies__itemBox').find('.edu  li').each(function () {
                var lcval = $(this).text().toLowerCase();
                if (lcval.indexOf(value) > -1) {
                    $(this).show()
            ...
            $(this).parents('.vacancies__itemBox').find('.job  li').each(function () {
                var lcval = $(this).text().toLowerCase();
                if (lcval.indexOf(value) > -1) {
                    $(this).show()
    ...
    useEffect(() => {
        ...
        let subCategoryLi = document.querySelectorAll('.subListed > li label > input');
        ...
        nagoLi.forEach(item => {
            ...
            if (query.get('is_nagotiable') !== null && query.get('is_nagotiable') === '1') {
                ...
                btn.onclick = function () {
                    ...
                    if (targetJob > -1) {
                        ...
                        if (query.get('jobexperiences') !== null) {
                            if (query.get('jobexperiences').split(',').indexOf(targetJobAttr) > -1) {
                    ...
                    if (targetEdu > -1) {
                        ...
                        if (query.get('education') !== null) {
                            if (query.get('education').split(',').indexOf(targetEduAttr) > -1) {
                    ...
                    if (targetCity > -1) {
                        ...
                        if (query.get('cities') !== null) {
                            if (query.get('cities').split(',').indexOf(targetCitiesAttr) > -1) {
                    ...
                    if (targetSubCate > -1) {
                        ...
                        if (query.get('subcategory') !== null) {
                            if (query.get('subcategory').split(',').indexOf(targetAttr) > -1) {
    ...
    let salaryMin = query.get('salary_rang_min') === 'NaN' || query.get('salary_rang_min') === null ? 0 : parseInt(query.get('salary_rang_min'))

    let salaryMax = query.get('salary_rang_max') === 'NaN' || query.get('salary_rang_max') === null ? 0 : parseInt(query.get('salary_rang_max'))
                                ...
                                <div className='vacancies__itemBox'>
                                    <div className='title'>
                                        <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2.49995 0.600097L7.99995 6.1001L13.5 0.600098L15.7 1.7001L7.99995 9.4001L0.29995 1.7001L2.49995 0.600097Z" fill="#01345A" />
                                        </svg>
                                        <h4>Kateqoriya</h4>
                                    </div>
                                            ...
                                            <ul className='listed'>
                                                {
                                                    ...
                                                    vacancySelectable.isLoading === false && (
                                                        vacancySelectable.data.data.categories.data.map(item => (
                                            ...
                                            <ul className='cities'>
                                                {
                                                    ...
                                                    vacancySelectable.isLoading === false && (
                                                        vacancySelectable.data.data.cities.data.map(item => (
                                            ...
                                            <ul className='edu'>
                                                {
                                                    ...
                                                    vacancySelectable.isLoading === false && (
                                                        vacancySelectable.data.data.educations.data.map(item => (
                                            ...
                                            <ul className='job'>
                                                {
                                                    ...
                                                    vacancySelectable.isLoading === false && (
                                                        vacancySelectable.data.data.jobexperiences.data.map(item => (
                        ...
                        <div className='vacancies__wrapper--right'>
                            ...
                            <div className='vacancies__job'>
                                    ...
                                    <div className='items'>
                                        {
                                            buttons !== null ? buttons.map((item, index) => (
                                                <div className='jobItem' key={index} data-category={item.value}>
                                                    <p className='deleteItem'>
                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M11.3536 1.35355L10.6465 0.646484L6.00005 5.29292L1.35361 0.646484L0.646484 1.35355L5.29295 6.00002L0.646484 10.6465L1.35361 11.3535L6.00005 6.70711L10.6465 11.3535L11.3536 10.6465L6.70714 6.00002L11.3536 1.35355Z" fill="#01345A" />
                                                        </svg>
                                                    </p>
                                                    <span>
                                                        {
                                        ...
                                        {
                                            buttonsCities !== null ? buttonsCities.map((item, index) => (
                                                <div className='jobItem' key={index} data-cities={item.value}>
                                                    <p className='deleteItem'>
                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M11.3536 1.35355L10.6465 0.646484L6.00005 5.29292L1.35361 0.646484L0.646484 1.35355L5.29295 6.00002L0.646484 10.6465L1.35361 11.3535L6.00005 6.70711L10.6465 11.3535L11.3536 10.6465L6.70714 6.00002L11.3536 1.35355Z" fill="#01345A" />
                                                        </svg>
                                        ...
                                        {
                                            buttonsEdu !== null ? buttonsEdu.map((item, index) => (
                                                <div className='jobItem' key={index} data-edu={item.value}>
                                                    <p className='deleteItem'>
                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M11.3536 1.35355L10.6465 0.646484L6.00005 5.29292L1.35361 0.646484L0.646484 1.35355L5.29295 6.00002L0.646484 10.6465L1.35361 11.3535L6.00005 6.70711L10.6465 11.3535L11.3536 10.6465L6.70714 6.00002L11.3536 1.35355Z" fill="#01345A" />
                                                        </svg>
                                        ...
                                        {
                                            buttonsJob !== null ? buttonsJob.map((item, index) => (
                                                <div className='jobItem' key={index} data-job={item.value}>
                                                    <p className='deleteItem'>
                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M11.3536 1.35355L10.6465 0.646484L6.00005 5.29292L1.35361 0.646484L0.646484 1.35355L5.29295 6.00002L0.646484 10.6465L1.35361 11.3535L6.00005 6.70711L10.6465 11.3535L11.3536 10.6465L6.70714 6.00002L11.3536 1.35355Z" fill="#01345A" />
                                                        </svg>
                                ...
                                <div className='jobPagination pagiEnd'>
                                    <span className='prev'>
                                        <svg width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.5 1.75L2.75 5.5L6.5 9.25L5.75 10.75L0.5 5.5L5.75 0.249999L6.5 1.75Z" fill="#01345A" />
                                        </svg>
                                    </span>
                                    <p>54-dən</p>

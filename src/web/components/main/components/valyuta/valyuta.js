...
// quries
import { exhange } from '../../../queries/queries';
...
const NewsDetail = () => {
    ...
    let [ex, setEx] = useState('usd')

    let { data, isLoading, isError } = useQuery(['ehange', ex], exhange)
    ...
    return (
        <main className='newsDetail valyuta' style={{ minHeight: 500 }}>
                    ...
                    <div className='newsDetail__flexBox'>
                        <div className='newsDetail__contentBox'>
                            <div className='newsDetail__left'>
                                ...
                                <div className='valyuta__title'>
                                    <h4>
                                        Bugünə olan məzənnə
                                    </h4>
                                </div>
                                <div className='valyuta__content'>
                                    <div className='valyuta__contentSelf'>
                                        <div className='valyuta__contentTitle'>
                                            <span>
                                                Valyuta
                                            </span>
                                            <span>
                                            ...
                                            <span>
                                                Bakının valyuta dəyişmə məntəqələrində ən yaxşı məzənnələr
                                            </span>
                                        </div>
                                        <div className='valyuta__wrapper'>
                                            <div className='valyuta__contentItem'>
                                                <div className='items'>
                                                    <p>
                                                        USD
                                                </p>
                                                ...
                                                <div className='items'>
                                                    ...
                                                    <svg width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M17.0523 2.65294L16.9983 0L14.8668 0.947477L14.8128 2.65294C6.52951 3.36354 0 11.3697 0 21.1287C0 21.7683 0.0269815 22.3841 0.0809444 23H2.96796C2.94098 22.5499 2.914 22.0999 2.914 21.6498C2.94098 12.7909 8.12142 5.49537 14.7319 4.73738L14.1383 21.3893L17.511 19.9681L17.1062 4.73738C23.7167 5.51905 28.8702 12.7909 28.8702 21.6498C28.8702 22.0999 28.8432 22.5499 28.8162 23H31.8921C31.946 22.3841 31.973 21.7683 31.973 21.1287C32 11.3223 25.3895 3.29248 17.0523 2.65294Z" fill="#C4C4C4" />
                                                        </svg>
                                                    </p>
                                                    <span>
                                                        1 ABŞ dolları üçün
                                                ...
                                                <div className='items'>
                                                    ...
                                                    <p className='itemsContent'>
                                                        Bank BTB, Naxçıvan Bank, Yelo Bank,
                                                        Access Bank, Express Bank
                                                </p>
                                                </div>
                                                <div className='items'>
                                                    <p>
                                            ...
                                            <div className='valyuta__contentItem noAfter'>
                                                <div className='items'>
                                                    <p>
                                                        USD
                                                </p>
                                ...
                                <div className='valyuta__footer'>
                                    <div className='layout'>

                                    </div>
                                    <h4 className='valyuta__footer--title'>
                                        7 yanvar 2021-ci ilə olan məzənnə kursları
                                    </h4>
                                    <div className='valyuta__footerWrapper'>
                                        <div className='valyuta__select'>
                                            <h4>Valyuta</h4>
                                            <select onChange={(event) => {
                                                changeItem(event)
                                            }}>
                                                <option value='usd'>USD — ABŞ dolları</option>
                                                <option value='rub'>Rubl — Russiya rubulu</option>
                                            </select>
                                        </div>
                                        <div className='valyuta__banks'>
                                            <div className='valyuta__banksTitle'>
                                                ...
                                                }
                                                {
                                                    isLoading === false && isError !== true && (
                                                        Object.keys(data).map((item) => {
                                                            ...
                                                            let values = Object.values(bank)

                                                            return (

                                                                <div className='valyuta__all--items'>
                                                                    <span>
                                                                        {
                                                                            key
                                                                        }
                                ...
                                {/*  valyuta footer*/}
                                <div className='valyuta__navLink'>
                                    <NavLink to={''}>
                                        Kredit müraciəti et
                                    </NavLink>
                                </div>

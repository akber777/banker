...
const CalcWork = () => {
    ...
    $(document).on('submit', '.calculator', function (e) {
        ...
        $('.calculator-result').animate({ opacity: 0 }, 'fast', function () {
            $('.calculator-result').html(calculate($('#inp1').val(), $('#inp2').val()).toFixed(2)).addClass('text-success').animate({ opacity: 1 })
        });
    ...
    function calculate(x, x2) {
        ...
        if (x < 2500) {
            ...
            result = x - x * 0.03 - 2500 * 0.14 - ((x - 2500) * 0.25) - x * 0.005 - x * x2 / 100;
        }
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="inp2" class="form-control" type="text" placeholder="%" />
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item text-center bg-light result-li">
                                    ...
                                    <span class="calculator-result text-success">
                                        0
                                    </span>
                                </li>

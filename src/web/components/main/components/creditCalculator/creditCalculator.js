...
const CreditCalculator = () => {
    ...
    function amort(balance, interestRate, terms) {
        ...
        var result = "<span><b>Aylıq ödəniş:</b></span> " + monthly + "</br>" +
            "<span><b>Kredit üzrə ümumi ödəniş :</b></span> " + totalPayment + "</br>" +
            "<span><b>Cəmi Faiz Ödənişi (itkisi) :</b></span> " + totalInterest + "<br/>";
    ...
    function getValues() {
        ...
        if (balVal && intrVal) {
            ...
            div.innerHTML += "Zəhmət olmasa girişlərinizi yoxlayın və yenidən cəhd edin - etibarsız dəyərlər.";
        }
                ...
                <div class="td-page-content">
                    ...
                    <form class="loan-calu">
                        <table>
                            <tbody>
                                <tr>
                                    <td><label for="principal">Kreditin məbləği</label></td>
                                    <td><input id="principal" style={{ width: '100%' }} type="text" /></td>
                                </tr>
                                <tr>
                                    <td><label for=" interest">Faiz dərəcəsi (illik %)</label></td>
                                    <td><input id="interest" style={{ width: '100%' }} type="text" /></td>
                                </tr>
                                <tr>
                                    <td><label for=" terms">Müddət</label></td>
                                    <td><input id="years" type="number"
                                        onClick={() => {
                                            changeMonthFromYear()
                                        }}
                                        onKeyUp={() => {
                                            changeMonthFromYear()
                                        }} /> &nbsp; İl &nbsp;<input id="terms" type="number"
